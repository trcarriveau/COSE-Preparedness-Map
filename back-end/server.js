...
const cmpDB = mongoose.connect('mongodb://localhost:27017/COSE-Preparedness-Map', {useNewUrlParser: true, useUnifiedTopology: true});
const app = express();
...
app.post('/login', 
  ...
  try {
    ...
    return res.status(200).json({ message: goodMsg, username: user.username, major: user.major, map: map });
